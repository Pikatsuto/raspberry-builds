    ...
    <div v-else class="space-y-8">
      ...
      <div v-if="stableReleases.length > 0">
        <div class="flex items-center space-x-2 mb-4">
          ...
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Stable Releases</h2>
        </div>
              ...
              <div class="flex items-start justify-between mb-4">
                <div>
                  <div class="flex items-center space-x-3">
                    ...
                    <span class="px-2 py-1 text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 rounded">Stable</span>
                  </div>
              ...
              <div v-if="getImageAssets(release).length > 0" class="space-y-2">
                ...
                <div class="grid grid-cols-1 gap-2">
                  <div
                    ...
                    :key="asset.id"
                    class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg dark:hover:bg-gray-900 transition-colors"
                  >
                    ...
                    <a
                      ...
                      target="_blank"
                      class="ml-4 inline-flex items-center px-3 py-1.5 text-white text-sm font-medium rounded transition-colors bg-blue-600 hover:!bg-blue-700"
                    >
      ...
      <!-- No Releases -->
      <div v-if="stableReleases.length === 0" class="text-center py-12">
